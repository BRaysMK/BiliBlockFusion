...
const shieldingOtherVideoParameter = async (result, videoData) => {
    ...
    return asyncBlockUserUidAndName(userInfo.uid, userInfo.name)
        ...
        .then(() => asyncBlockVideoFavoriteCoinRatio(videoInfo.favorite, videoInfo.coin, videoInfo.view, videoInfo.pubdate))
        .then(() => asyncBlockVideoPartition(videoInfo?.tname))
