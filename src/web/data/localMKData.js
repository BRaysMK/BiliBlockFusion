...
// 获取评论字数限制类型 (max/min)
export const getCommentWordLimitType = () => {
    return GM_getValue('comment_word_limit_type', 'max')
}

// 是否启用评论字数限制
export const isEnableCommentWordLimitGm = () => {
